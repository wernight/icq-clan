// ControleurDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CControleurDlg message handlers
...
BOOL CControleurDlg::OnInitDialog()
{
	...
	// Charge
	m_strIP = AfxGetApp()->GetProfileString("Connexion", "Serveur", "");
	UpdateData(FALSE);
	
	return TRUE;  // return TRUE  unless you set the focus to a control
}

void CControleurDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CControleurDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CControleurDlg::OnOK() 
{
	// Enregistre
	UpdateData(TRUE);
	AfxGetApp()->WriteProfileString("Connexion", "Serveur", m_strIP);
